...
pub fn setup() -> Result<String, Error> {
    ...
    let stdout = dag()
        ...
        .with_exec(vec![
            "grep -q meilisearch Procfile || echo 'typesense: typesense --data-dir $TYPESENSE_DATADIR --api-key $TYPESENSE_API_KEY --api-host $TYPESENSE_API_HOST --api-port $TYPESENSE_API_PORT' >> Procfile",
        ])?
        .stdout()?;
